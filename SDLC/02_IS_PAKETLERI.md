...
## İP-3 · Kapalı-döngü nöromekanik kontrolcü — **bitti (sonuç: 9of9)**
...
- **Not (2026-09-05 düzeltmesi):** "güncel sürümler repo dışında" kaydı **yanlıştı**; güncel
  `cl_*.py` ve `cl_grid3d.npz` repodadır. Sonuç koşusu bu makinede yeniden koşuldu ve 24 çıktı
...
- **Adımlar:**
  1. ~~Derleme yolunu kur~~ **çözüldü (2026-09-05):** `nrnivmodl` boşluklu proje yolunda kurulu
     ...
     proje içinde sorunsuz koşuyor. Adımlar: `06_KURULUM.md` Adım 1 ve 3.
  ...
  4. `motor_unit.hoc` hattını Python'dan (veya HOC'tan) koştur; GUI'siz (batch) koşu yolu kur.
...
- **Çıktı:** derlenmiş mekanizmalar, batch koşu betiği, doğrulama kaydı.
...
- **Kapsam:**
  ...
  - Zaman adımı, birim ve ölçek kuralını yazılı hale getir (NEURON ms/mV/uS ile
...
- **Hedef:** Repoyu klonlayan birinin projeyi çalıştırabilmesi.
- **Bitti (2026-09-05):**
  ...
  - ~~Repo-dışı kritik dosyaların durumu çözülsün~~ → yeniden ölçüldü: `cl_grid3d.npz`, güncel
    `cl_*.py` ve `cl_best_9of9.json` **repodadır**; kayıt yanlıştı. Kapalı döngü koşuyor.
...
- **Kalan:**
  ...
  - `veri/kapali_dongu/cl_grid3d.npz` ve `arsiv/veri/cl_ref.npz` yeniden üretilemez (üreteçleri `stage0_grid.py`,
    `gate2_ref.py` hiç repoya girmedi) — bunlar getirilsin ya da durum kabul edilip yazılsın.
...
## İP-7 · Literatür özeti dosyaları — **todo**
